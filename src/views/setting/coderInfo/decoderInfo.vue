<template>
  <div>
    <div class="codertit" v-if="showpage">
      <h2 ref="tit">
        解码器-{{ decoderInfo.baseinfo.alias }}
              ...
              <div class="coderPageCon">
                <ul>
                  <li class="coder_li">
                    ...
                    <p class="coder_value">{{ decoderInfo.baseinfo.module }}</p>
                  </li>
                  <li class="coder_li">
                  ...
                  <li class="coder_li">
                    ...
                    <p class="coder_value">
                      {{ decoderInfo.baseinfo.active ? "在线" : "不在线" }}
                    </p>
                  </li>
                  <li class="coder_li">
                    <p class="coder_name">HDMI接口数量：</p>
                    <p class="coder_value">{{ decoderInfo.HDMI.length }}</p>
                  </li>
                  <li class="coder_li">
                    <p class="coder_name">模拟音频数量：</p>
                    <p class="coder_value">
                      {{ decoderInfo.AnalogAudio.length }}
                    </p>
                  </li>
                </ul>
              ...
              <div class="coderPageCon">
                <ul>
                  <li class="coder_li">
                    ...
                    <p class="coder_value">{{ decoderInfo.baseinfo.id }}</p>
                  </li>
                  <li class="coder_li">
          ...
          <div class="coderPage" v-if="coderIndex == 3">
            <div class="pageCon">
              <div class="coderPageCon">
                <ul>
                  <li class="coder_li">
                    <p class="coder_name">输出负载：</p>
                    <p class="coder_value">
                      {{
                        decoderInfo.HDMI[0].sink[0].monitor.state.connected
                          ? "在线"
                          : "不在线"
                      }}
                    </p>
                  ...
                  <li
                    class="coder_li"
                    v-show="decoderInfo.HDMI[0].sink[0].monitor.state.connected"
                  >
            ...
            <div class="pageCon">
              <div class="coderPageCon">
                <ul>
                  ...
                  <li
                    class="coder_li"
                    v-if="decoderInfo.HDMI[0].subscript[0].config.mode != null"
                  >
                    <p class="coder_name">工作模式：</p>
                    <p class="coder_value">
                      {{ decoderInfo.HDMI[0].subscript[0].config.mode }}
                    </p>
                  </li>
                  <li class="coder_li">
                    <p class="coder_name">点对点模式：</p>
                    <select name="" class="select_big" v-model="modeselect">
                      <option v-for="(item, index) in modeselectarr" :key="index">
                        {{ item.value }}
                      </option>
                    </select>
                  </li>
                  <li class="coder_li" v-if="modeselect != '帧同步'">
                    <p class="coder_name">输出分辨率：</p>
                    <select name="" class="select_big" v-model="fblselect">
                      <option v-for="(item, index) in fblselectarr" :key="index">
                        {{ item.value }}
                      </option>
                    </select>
                  </li>
              ...
              <div class="coderPageCon">
                <ul>
                  ...
                  <li class="coder_li">
                    ...
                    <p class="coder_value">
                      {{
                        decoderInfo.AnalogAudio[0].config.direction == "OUTPUT"
                          ? "输出"
                          : "输入"
                      }}
                    </p>
              ...
              <div class="coderPageCon">
                <ul>
                  <li class="coder_li">
                    ...
                    <p class="coder_value">
                      {{ decoderInfo.baseinfo.firmware_version }}
                    </p>
                  </li>
                  <li class="coder_li">
...
export default {
  ...
  data() {
    return {
      ...
      fblselectarr: [
        ...
        { value: "1360×768@60Hz" },
        //  "1280×930@60Hz",
        { value: "1280×1024@60Hz" },
        //  "1400×1050@60Hz",
        { value: "1600×1200@60Hz" },
        { value: "1920×1200@60Hz" },
        //  "480I@59.94Hz",
        //  "480P@59.94Hz",
        { value: "1280×720@60Hz" }, //"720P@60Hz", // 1280*720@60
        //  "720P@59.94Hz",
        //  "1080I@60Hz",
        //  "1080I@59.94Hz",
        { value: "1920×1080@30Hz" }, //"1080P@30Hz",
        //  "1080P@29.97Hz",
        //  "1080P@24Hz",
        //  "1080P@23.97Hz",
        { value: "1920×1080@60Hz" }, //"1080P@60Hz", // 1920*1080@60Hz
        //  "1080P@59.94Hz",
        //  "576I@50Hz",
        //  "576P@50Hz",
        // "720P@50Hz",
        //  "1080I@50Hz",
        { value: "1920×1080@25Hz" }, //"1080P@25Hz",
        //  "1080P@50Hz",
        { value: "3840×2160@30Hz" },
        //  "3840×2160@29.97Hz",
        { value: "3840×2160@25Hz" },
        //  "3840×2160@24Hz",
        // "3840×2160@23.98Hz",
        //  "4096×2160@24Hz",
        { value: "3840×2160@60Hz" },
        //  "3840×2160@59.94Hz",
        //  "3840×2160@50Hz",
        { value: "4096×2160@30Hz" },
        //  "4096×2160@29.97Hz",
        { value: "4096×2160@25Hz" },
        //  "4096×2160@23.976Hz",
        { value: "4096×2160@60Hz" },
        //  "4096×2160@59.94Hz",
        //  "4096×2160@50Hz",
      ],
      fblselect: "1920×1080@60Hz",
      modeselectarr: [
        { value: "帧同步", option: 1 },
        { value: "帧同步Scaling", option: 2 },
        { value: "快速切换", option: 3 },
        { value: "快速切换Crop", option: 4 },
        { value: "快速切换Stretch", option: 5 },
      ],
      modeselect: "",
      portselectarr: [
        { value: "输入", option: 1 },
  ...
  methods: {
    ...
    upgradeFirmware() {
      ...
      Modal.confirm({
        title:
          "是否升级设备" + that.decoderInfo.baseinfo.alias + "--" + that.fileipselect,
        okText: "确定",
        cancelText: "取消",
        onOk() {
    ...
    switch() {
      let that = this;
      let deviceInfo = that.decoderInfo;
      that.edid = that.decoderInfo.HDMI[0].sink[0].monitor.state.edid;
      ...
      that.page1name = that.decoderInfo.baseinfo.alias;
      that.ipselect = that.decoderInfo.network.DHCP
        ? "自动获取IP地址"
        : "使用下面的IP地址";
      ...
      that.audiodelay = that.decoderInfo.HDMI[0].subscript[1].config.audio_delay;
      that.page4name = that.decoderInfo.HDMI[0].subscript[1].config.alias;
      that.page5name = that.decoderInfo.AnalogAudio[0].config.alias;
      switch (that.decoderInfo.HDMI[0].subscript[0].config.p2pmode) {
        case "genlock":
          that.modeselect = "帧同步";
          break;
        case "genlock_scaling":
          that.modeselect = "帧同步Scaling";
          break;
        case "fastswitch":
          that.modeselect = "快速切换";
          break;
        case "fastswitch crop":
          that.modeselect = "快速切换Crop";
          break;
        case "fastswitch stretch":
          that.modeselect = "快速切换Stretch";
          break;
      }
      if (that.modeselect != "帧同步") {
        ...
        that.fblselect =
          ...
          "×" +
          that.decoderInfo.HDMI[0].subscript[0].config.output.height +
          "@" +
          that.decoderInfo.HDMI[0].subscript[0].config.output.fps +
          "Hz";
        that.decoderInfo.fblselect =
          that.decoderInfo.HDMI[0].subscript[0].config.output.width +
          "×" +
          that.decoderInfo.HDMI[0].subscript[0].config.output.height +
          "@" +
      ...
      that.hdcpselect =
        that.decoderInfo.HDMI[0].sink[0].config.hdcp_output_mode == "FOLLOW_SOURCE"
          ? "跟随输入"
          : "跟随输出";
    },
    getdevice() {
        ...
        if (res.data.status == "SUCCESS") {
          ...
          for (let i = 0; i < deviceInfo.length; i++) {
            if (deviceInfo[i].baseinfo.id == that.$store.state.coderID) {
              that.decoderInfo = deviceInfo[i];
              that.showpage = true;
              // console.log(JSON.stringify(that.decoderInfo));
              that.edid = that.decoderInfo.HDMI[0].sink[0].monitor.state.edid;
              if (EDID.setEdidData(that.edid) == "errorEDID") {
                that.edidread = false;
                that.ediderr = "ERROR EDID: " + EDID.EDIDERR();
              ...
              that.ipselect = that.decoderInfo.network.DHCP
                ? "自动获取IP地址"
                : "使用下面的IP地址";
              that.deviceId = that.decoderInfo.device_id;
              that.ipaddr = that.decoderInfo.network.ip_address;
              that.maskaddr = that.decoderInfo.network.submask;
              that.gatewayaddr = that.decoderInfo.network.gateway;
              that.audiodelay = that.decoderInfo.HDMI[0].subscript[1].config.audio_delay;
              that.page4name = that.decoderInfo.HDMI[0].subscript[1].config.alias;
              that.page5name = that.decoderInfo.AnalogAudio[0].config.alias;
              // HDMI[0].subscript[0].config.p2pmode
              switch (that.decoderInfo.HDMI[0].subscript[0].config.p2pmode) {
                case "genlock":
                  that.modeselect = "帧同步";
                  break;
              ...
              that.hdcpselect =
                that.decoderInfo.HDMI[0].sink[0].config.hdcp_output_mode ==
                "FOLLOW_SOURCE"
                  ? "跟随输入"
                  : "跟随输出";
            }
    ...
    coderfront() {
      ...
      for (let i = 0; i < deviceInfo.length; i++) {
        if (this.$store.state.coderID == deviceInfo[i].baseinfo.id) {
          ...
          if (this.$store.state.coderMsg.baseinfo.type == 0) {
            this.$router.push({ path: "/views/encoder" });
          } else {
            this.decoderInfo = this.$store.state.coderMsg;
            this.getdevice();
          }
          break;
        }
    ...
    savePage1() {
      if (this.page1name != this.decoderInfo.baseinfo.alias) {
        console.log("改变名称");
        let aodata = {
          command: {
            type: "set",
    ...
    handupDevice() {
      ...
      let errormsg;
      let state;
      if (!that.decoderInfo.baseinfo.HandUp) {
        titmsg = "是否打开设备闪烁灯";
      ...
      let aodata = {
        command: {
          ...
          device_mode: "SDVOE",
          data: {
            device: that.decoderInfo.baseinfo.id,
            Handup: state,
          },
        },
      };
    ...
    savePage2() {
      ...
      let getstate = this.decoderInfo.network.DHCP;
      if (
        this.ipaddr != this.decoderInfo.network.ip_address ||
        this.maskaddr != this.decoderInfo.network.submask ||
        this.gatewayaddr != this.decoderInfo.network.gateway ||
        setstate != getstate
      ) {
        console.log("修改网络参数");
    ...
    savePage3() {
      ...
      if (
        ...
        this.hdcpselect !=
          (this.decoderInfo.HDMI[0].sink[0].config.hdcp_output_mode == "FOLLOW_SOURCE"
            ? "跟随输入"
            : "跟随输出")
      ) {
        if (mode != this.decoderInfo.HDMI[0].subscript[0].config.p2pmode) {
          let aodata;
          if (mode == "genlock") {
            aodata = {
              command: {
                type: "set",
                command: "DeviceSwitchMode",
                device_mode: "SDVOE",
                data: {
                  device: this.decoderInfo.baseinfo.id,
                  p2pmode: mode,
                },
              },
            };
            ...
            aodata = {
              command: {
                ...
                data: {
                  ...
                  p2pmode: mode,
                  output: {
                    width: this.fblselect.split("×")[0],
                    height: this.fblselect.split("×")[1].split("@")[0],
                    fps: this.fblselect.split("@")[1].split("H")[0],
                  },
                },
              },
            };
        ...
        if (
          ...
          this.$axios.post("api/device/sdvoe", aodata).then(function (res) {
            if (res.data.status == "SUCCESS") {
              notification.success({
                message: "修改HDCP跟随状态成功",
                duration: 1,
              });
              that.getdevice();
            } else {
              notification.error({
                message: "修改HDCP跟随状态失败",
                duration: 1,
              });
            }
          });
    ...
    savePage4() {
      let name = this.decoderInfo.HDMI[0].subscript[1].config.alias;
      if (
        name != this.page4name ||
        this.audiodelay != this.decoderInfo.HDMI[0].subscript[1].config.audio_delay
      ) {
        ...
        if (this.audiodelay != this.decoderInfo.HDMI[0].subscript[1].config.audio_delay) {
          if (this.audiodelay > 5000 || this.audiodelay < 0) {
            notification.warning({
              message: "延迟出声参数设置错误(0~5000)",
              duration: 1,
            });
            return;
          }
          let aodata = {
            command: {
              type: "set",
              command: "DeviceDeCodeHDMIAudioDelay",
              device_mode: "SDVOE",
              data: {
                device: this.$store.state.coderID,
                delay: parseInt(this.audiodelay),
              },
            },
          };
          let that = this;
          this.$axios.post("api/device/sdvoe", aodata).then(function (res) {
            if (res.data.status == "SUCCESS") {
              notification.success({
                message: "设置音频延迟出声时间成功",
                duration: 1,
              });
              that.getdevice();
            } else {
              notification.error({
                message: "设置音频延迟出声时间失败",
                duration: 1,
              });
            }
          });
    ...
    savePage5() {
      let name = this.decoderInfo.AnalogAudio[0].config.alias;
      if (name != this.page5name) {
        ...
        for (let i = 0; i < this.page5name.length; i++) {
          if (this.page5name.charCodeAt(i) > 127 || this.page5name.charCodeAt(i) == 94) {
            len += 2;
          } else {
            len++;
          }
  ...
  created() {
    let that = this;
    console.log("input 2");
    that.decoderInfo = that.$store.state.coderMsg;
    that.getUpgradeFile();
    that.getdevice();
    if (that.$store.state.openPageAvalue == "digitaloutA") {
      that.coderIndex = 5;
    } else if (that.$store.state.openPageAvalue == "analogoutA") {
      that.coderIndex = 6;
    }
  },
  mounted() {},
